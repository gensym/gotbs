...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t2929) {
      cljs.core.t2929 = {};
      cljs.core.t2929 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta2930 = c;
      ...
      cljs.core.t2929.cljs$lang$type = !0;
      cljs.core.t2929.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t2929")
      };
      cljs.core.t2929.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t2929")
      };
      var c = cljs.core.t2929.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t2929.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t2929.prototype.cljs$core$Fn$ = !0;
      cljs.core.t2929.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta2930
      };
      cljs.core.t2929.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t2929(this.meta, this.f, b)
      }
    }
    return new cljs.core.t2929(b, a, null)
  }(), b)
};
...
console.log("FFFuuu");
gotbs.js.timeline.draw_path = function(a, b) {
  ...
  a.beginPath();
  a.moveTo(d, c);
  for(d = cljs.core.seq.call(null, cljs.core.rest.call(null, b));;) {
    if(d) {
      var e = cljs.core.first.call(null, d), c = cljs.core.nth.call(null, e, 0, null), e = cljs.core.nth.call(null, e, 1, null);
      a.lineTo(c, e);
      d = cljs.core.next.call(null, d)
    }else {
      break
...
gotbs.js.timeline.scale_points = function(a, b, c, d, e, f, g) {
  var h = b - a, i = e - d;
  return cljs.core.map.call(null, function(b) {
    var e = cljs.core.nth.call(null, b, 0, null), b = cljs.core.nth.call(null, b, 1, null);
    return cljs.core.PersistentVector.fromArray([(e - a) / (h * c), (b - d) / (i * f)], !0)
  }, g)
};
gotbs.js.timeline.find_range = function(a) {
  return cljs.core.reduce.call(null, function(a, c) {
    var d = cljs.core.nth.call(null, a, 0, null), e = cljs.core.nth.call(null, a, 1, null), f = cljs.core.nth.call(null, a, 2, null), g = cljs.core.nth.call(null, a, 3, null), h = cljs.core.nth.call(null, c, 0, null), i = cljs.core.nth.call(null, c, 1, null);
    return cljs.core.PersistentVector.fromArray([d < h ? d : h, e > h ? e : h, f < i ? f : i, g > i ? g : i], !0)
  }, cljs.core.PersistentVector.fromArray([0, 0, 0, 0], !0), cljs.core.apply.call(null, cljs.core.concat, a))
};
gotbs.js.timeline.draw_canvas = function(a, b) {
  var c = document.getElementById(a), d = c.getContext("2d"), e = c.width, c = c.height, f = gotbs.js.timeline.find_range.call(null, b), g = cljs.core.nth.call(null, f, 0, null), h = cljs.core.nth.call(null, f, 1, null), i = cljs.core.nth.call(null, f, 2, null), f = cljs.core.nth.call(null, f, 3, null), g = cljs.core.map.call(null, cljs.core.partial.call(null, gotbs.js.timeline.scale_points, g, h, e, i, f, c), b);
  d.clearRect(0, 0, e, c);
  d.save();
  d.lineWidth = 1.5;
  for(e = cljs.core.seq.call(null, g);;) {
    if(e) {
      c = cljs.core.first.call(null, e), gotbs.js.timeline.draw_path.call(null, d, c), e = cljs.core.next.call(null, e)
    }else {
      break
    }
  }
